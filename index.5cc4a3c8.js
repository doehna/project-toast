...
function $85c7828d4abf996e$var$ToastProvider({ children: children }) {
    const [radioButtonValue, setRadioButtonValue] = (0, (/*@__PURE__*/$parcel$interopDefault($iS7v4))).useState((0, $cdb49e4e8e61372a$export$16e593cddeb30741)[0]);
    ...
    const addNewToast = (0, (/*@__PURE__*/$parcel$interopDefault($iS7v4))).useCallback((key = Math.random())=>{
        setTextAreaValue("");
        setRadioButtonValue((0, $cdb49e4e8e61372a$export$16e593cddeb30741)[0]);
...
//# sourceMappingURL=index.5cc4a3c8.js.map
